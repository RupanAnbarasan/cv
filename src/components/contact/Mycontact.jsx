  ...
  return (
    ...
    <div className="my-contact">
      ...
      <li><a href='https://github.com/RupanAnbarasan' rel="noreferrer"target="_blank"><GitHubIcon className='social-icon' /></a></li>
        ...
        <li><a href='https://www.google.com/maps/place/Salem,+Tamil+Nadu/@11.6537234,78.0558951,12z/data=!3m1!4b1!4m6!3m5!1s0x3babf1ccf52cba0b:0xee9989007068ca47!8m2!3d11.664325!4d78.1460142!16zL20vMDFqbmdz?entry=ttu' rel="noreferrer"target="_blank"><LocationOnIcon className='social-icon'/></a></li>
      </ul>
    </div>
  );
};
